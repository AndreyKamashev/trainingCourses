<div class="box">
    ...
    <div class="box-body">
		<div class="mt-2 mb-4">
            <button type="button" data-toggle="modal" data-target="#myModal" class="btn btn-sm bg-blue btn-flat"><i class="fa fa-plus"></i> Добавить</button>
			...
			<div class="pull-right">
				<button onclick="bulk_edit()" class="btn btn-sm btn-warning btn-flat" type="button"><i class="fa fa-edit"></i> Ред.</button>
				<button onclick="bulk_delete()" class="btn btn-sm btn-danger btn-flat" type="button"><i class="fa fa-trash"></i> Удалить</button>
			</div>
		</div>
        <?=form_open('',array('id'=>'bulk'))?>
        <table id="themes" class="w-100 table table-striped table-bordered table-hover">
            <thead>
                <tr>
                    <th>#</th>
...
<div class="modal fade" id="myModal">
	<div class="modal-dialog modal-sm">
		<div class="modal-content">
            ...
            <?=form_open('themes/add', array('id', 'tambah'));?>
...
<script src="<?=base_url()?>assets/dist/js/app/master/themes/data.js"></script>