                    ...
                    <div class="col-sm-8 col-sm-offset-2">
                        <div class="row">
                            <div class="form-group col-sm-12">
                                <label for="lecturer_id" class="control-label">Преподаватель (Курсы)</label>
                                ...
                                <select required="required" name="lecturer_id" id="lecturer_id" class="select2 form-group" style="width:100% !important">
                                    ...
                                    <?php
                                    $sdm = $soal->lecturer_id.':'.$soal->courses_id;
                                    foreach ($lecturer as $d) :
                                        $dm = $d->id_lecturer.':'.$d->courses_id;?>
                                        <option <?=$sdm===$dm?"selected":"";?> value="<?=$dm?>"><?=$d->name_lecturer?> (<?=$d->name_courses?>)</option>
                                    <?php endforeach; ?>
                                </select>
                            ...
                            <div class="col-sm-12">
                                <label for="soal" class="control-label text-center">Вопрос</label>
                                <div class="row">
                            ...
                            <div class="col-sm-12">
                                <label for="jawaban_<?= $abj; ?>" class="control-label text-center">Ответ <?= $ABJ; ?></label>
                                <div class="row">
                                    <div class="form-group col-sm-3">
