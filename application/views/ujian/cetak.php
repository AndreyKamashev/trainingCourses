...
$pdf->SetAuthor('Tim Patrik');
$pdf->SetTitle('Результат опроса');
...
<table id="data-peserta">
    ...
    <tr>
        <th>Группа</th>
        <td>{$mhs->name_classes}</td>
    </tr>
    <tr>
        <th>Тема</th>
        <td>{$mhs->name_themes}</td>
    </tr>
</table>
<h2>Данные опросов</h2>
<table id="data-hasil">
    <tr>
        <th>Курс</th>
...
$pdf->Output($ujian->name_ujian.'_'.$mhs->nim.'.pdf', 'I');
