...
class HasilUjian extends CI_Controller {
	...
	public function data()
	{
		...
		$this->output_json($this->ujian->getHasilUjian($nip_lecturer), false);
	}
	...
	public function detail($id)
	{
		...
		//$answer = explode(":",$nilai->list_jawaban);
		$result_soap = $this->ujian->get_soap_nilai($nilai->list_soal);
