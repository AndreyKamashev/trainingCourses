$(document).ready(function(){
    ...
    $('form#login').on('submit', function(e){
        ...
        infobox.addClass('callout callout-info').text('Проверка...');

        var btnsubmit = $('#submit');
        btnsubmit.attr('disabled', 'disabled').val('Подождите...');
        ...
        success: function(data){
            ...
            btnsubmit.removeAttr('disabled').val('Вход');
            if(data.status){
                infobox.addClass('callout callout-success text-center').text('Логин проверен.');
